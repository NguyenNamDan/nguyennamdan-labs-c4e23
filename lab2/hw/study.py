...
dl = YoutubeDL()
dl.download(['https://www.youtube.com/watch?v=4wRPrS6ka-k']) # Remember to put your video in a list, eventhough one video is downloaded
...
dl.download(['https://www.youtube.com/watch?v=4wRPrS6ka-k'])
